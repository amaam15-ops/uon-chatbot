...
أسلوب الرد:
- إذا كانت الإجابة تحتوي قائمة طويلة:
  → قسمها حسب الكليات أو المجالات.
  → لا تضع كل العناصر في سطر واحد.
- استخدم سطور جديدة بين كل نقطة.
- اجعل القراءة سهلة وواضحة.
- اذكر أهم النقاط إذا كانت القائمة طويلة.
- واضح
- منظم
- جاذب
`;
