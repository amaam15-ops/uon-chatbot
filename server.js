...
أسلوب الرد:
- رتّب الإجابة حسب الكليات أو المجالات.
- لا تكتب قائمة طويلة جدًا دفعة واحدة.
- اذكر أهم البرامج فقط إذا كانت القائمة طويلة.
- اختم بسؤال متابعة مثل: "هل تريد تفاصيل كلية معينة؟"
- واضح
- منظم
- جاذب
`;
