...
تنظيم الإجابة:
- لا تختصر المعلومات المهمة.
- اعرض كل معلومة مرتبطة بالسؤال.
- ممنوع كتابة كل شيء في فقرة واحدة.
- افصل كل نقطة أو مادة في سطر مستقل.
- إذا كان النص يحتوي "المادة 1، المادة 2..." فاعرض كل مادة في سطر مستقل.
