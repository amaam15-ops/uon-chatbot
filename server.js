...
- افصل كل نقطة في سطر مستقل.
- رقّم المواد بالتسلسل الصحيح: المادة 1، المادة 2، المادة 3 (لا تكرر نفس الرقم).
- اكتب رقم المادة هكذا: "المادة 1:" بدون أي أقواس.
- ممنوع كتابة قوس مفرد ) أو ( في الإجابة نهائيًا.
- ضع نقطة (.) في نهاية كل جملة وليس قوسًا.
- استخدم • للقوائم.
- استخدم سطرًا فارغًا بين المجموعات.
- ممنوع استخدام ## أو --- أو أي Markdown.
